...
def home(request):
    return render(request,'sel_templates/home.html')

def edit_profile(request):
    return render(request,'sel_templates/edit_profile.html')

def master(request):
    return render(request,'sel_templates/master.html')
...
def product_catelogue(request):
    return render(request,'sel_templates/product_catelogue.html')
